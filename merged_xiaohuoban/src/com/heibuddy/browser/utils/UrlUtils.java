...
public class UrlUtils {
	...
	public static void goToTheUrl(Context context, String url) {
		Uri uriUrl = Uri.parse(url);
		Intent launchBrowser = new Intent(Intent.ACTION_VIEW, uriUrl, context, BrowserMainActivity.class);
//		launchBrowser.addFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
